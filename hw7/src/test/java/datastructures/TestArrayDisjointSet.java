...
public class TestArrayDisjointSet extends BaseTest {
    ...
    //
    //     ArrayDisjointSet<String> forest = (ArrayDisjointSet) this.createForest(items);
    //
    //     forest.union("a", "b");
    //     forest.union("c", "d");
    //     forest.union("a", "c");
    //     int root = forest.findSet("c");
    //     assertEquals(-3, forest.pointers[forest.findSet("c")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("a")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("b")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("d")]);
    //     for (int i = 0; i < 3; i++){
    //         if (i != root) {
    //             assertEquals(root, forest.pointers[i]);
    //         }
    //     }
    //
    //
    //     forest.union("e", "f");
    //     forest.union("f", "g");
    //     assertEquals(-2, forest.pointers[forest.findSet("e")]);
    //     forest.union("e", "c");
    //     assertEquals(-3, forest.pointers[forest.findSet("a")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("b")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("c")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("d")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("e")]);
    //     assertEquals(-3, forest.pointers[forest.findSet("f")]);
    //     root = forest.findSet("c");
    //     for (int i = 0; i < 6; i++){
    //         if (i != root) {
    //             assertEquals(root, forest.pointers[i]);
    //         }
